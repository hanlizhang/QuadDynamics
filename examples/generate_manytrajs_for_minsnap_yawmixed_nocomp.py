...
def main():
    ...
    # also append fix yaw data
    #  Create a list of yaw values ranging from 0 to 2*pi
    ...
    for radius in desired_radius:
        for yaw in yaw_values:
            ...
            waypoints = waypoints[::-1]  # reverse the waypoints
            # Set up trajectory.
            traj = MinSnap(
                waypoints,
                yaw_angles,
