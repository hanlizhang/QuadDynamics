...
class TwoDLissajous(object):
    ...
    def update(self, t):
        ...
        x = np.array(
            [
                self.A * np.sin(self.a * t + self.delta),
        ...
        x_dot = np.array(
            [
                self.a * self.A * np.cos(self.a * t + self.delta),
        ...
        x_ddot = np.array(
            [
                -((self.a) ** 2) * self.A * np.sin(self.a * t + self.delta),
        ...
        x_dddot = np.array(
            [
                -((self.a) ** 3) * self.A * np.cos(self.a * t + self.delta),
        ...
        x_ddddot = np.array(
            [
                (self.a) ** 4 * self.A * np.sin(self.a * t + self.delta),
