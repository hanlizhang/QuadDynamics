...
quad_params = {
    ...
    "rotor_pos": {
        "r1": d
        * np.array([0.70710678118, 0.70710678118, 0]),  # Location of Rotor 1, meters
        "r2": d
        * np.array([0.70710678118, -0.70710678118, 0]),  # Location of Rotor 2, meters
        "r3": d
        * np.array([-0.70710678118, -0.70710678118, 0]),  # Location of Rotor 3, meters
        "r4": d
        * np.array([-0.70710678118, 0.70710678118, 0]),  # Location of Rotor 4, meters
    },
